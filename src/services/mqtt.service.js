...
class MQTTService {
  ...
  // Para tiwater: guardar primero en PostgreSQL para que script/dashboard/externo siempre actualicen sensores aunque MongoDB falle
  async saveSensorData(data) {
    ...
    try {
      ...
      try {
        ...
        if (isTiwater) {
          console.warn('[MQTT] ⚠️  MongoDB save skipped (PostgreSQL already updated):', mongoError.message);
        } else {
          throw mongoError;
        }
      }
